...
const ALL_PAGES = {
    ...
    separacoes_canceladas: "Separações Canceladas",
    gerenciar_clientes: "Gerenciar Clientes",
    anotacoes: "Anotações (Kanban)",
    gerenciar_prioridade: "Gerenciar Prioridade (Kanban)",
    tv_prioridade: "TV Prioridade (Painel)",
